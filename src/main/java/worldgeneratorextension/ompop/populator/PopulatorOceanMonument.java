package worldgeneratorextension.ompop.populator;
...
public class PopulatorOceanMonument extends Populator {
    ...
    public static class OceanMonumentStart extends StructureStart {
        ...
        public void generatePieces(ChunkManager level, int chunkX, int chunkZ) {
            this.pieces.add(new OceanMonumentPieces.MonumentBuilding(this.random, (chunkX << 4) - 29, (chunkZ << 4) - 29, BlockFace.Plane.HORIZONTAL.random(this.random)));
