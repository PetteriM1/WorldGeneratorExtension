...
import worldgeneratorextension.theend.scheduler.ChunkGenerationTask;
import worldgeneratorextension.theend.scheduler.ChunkGenerationTask.ChunkListener;
...
public class PopulatorPodium extends Populator implements ChunkListener {
    ...
    public void populate(ChunkManager level, int chunkX, int chunkZ, NukkitRandom random, FullChunk chunk) {
        ...
        if (!chunks.isEmpty()) {
            chunks.forEach(ck -> Server.getInstance().getScheduler().scheduleAsyncTask(Loader.INSTANCE, new ChunkGenerationTask(this.level, ck, this)));
            return;
        }
