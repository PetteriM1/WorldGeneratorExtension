package worldgeneratorextension.theend.generator;
...
import worldgeneratorextension.theend.noise.PerlinOctaveGenerator;
...
import worldgeneratorextension.theend.populator.theend.PopulatorChorusPlant;
import worldgeneratorextension.theend.populator.theend.PopulatorEndGateway;
import worldgeneratorextension.theend.populator.theend.PopulatorEndIsland;
import worldgeneratorextension.theend.populator.theend.PopulatorObsidianPillar;
import worldgeneratorextension.theend.populator.theend.PopulatorPodium;
...
public class TheEndGenerator extends Generator {
    ...
    protected static double heightScale = 1368.824d;
    ...
    public void init(ChunkManager level, NukkitRandom random) {
        ...
        this.populators.add(new PopulatorPodium(true, false));
    ...
    public void populateChunk(int chunkX, int chunkZ) {
        ...
        EnumBiome.END.biome.populateChunk(this.level, chunkX, chunkZ, this.nukkitRandom);
    }
